...
class SayTest < Minitest::Test
  ...
  def test_one_hundred_eleven
    number = 111
    assert_equal 'one hundred eleven', Say.new(number).in_english
  end

  def test_one_hundred_twenty
    number = 120
    assert_equal 'one hundred twenty', Say.new(number).in_english
  end
  ...
  def test_one_million_twelve_thousand
    number = 1_012_000
    assert_equal 'one million twelve thousand', Say.new(number).in_english
  end
  ...
  def test_one_million_thirteen_thousand_three_hundred_forty_five
    number = 1_013_345
    assert_equal 'one million thirteen thousand three hundred forty-five', Say.new(number).in_english
  end
